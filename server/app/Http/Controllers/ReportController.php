...
class ReportController extends Controller
{
    ...
    public function generateCloseoutReport(int $cashier, Carbon $start, Carbon $end): array
    {
        $filters = [
            ['created_at', '>=', $start],
            ['created_at', '<=', $end],
    ...
    public function generatePaymentReport(int $cashier, Carbon $start, Carbon $end): array
    {
        $filters = [
            ['created_at', '>=', $start],
            ['created_at', '<=', $end],
