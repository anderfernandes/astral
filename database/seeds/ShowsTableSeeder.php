...
class ShowsTableSeeder extends Seeder
{
    ...
    public function run()
    {
      ...
      DB::table('shows')->insert([
        ...
        'duration'    => 25,
        'description' => 'Write a description here.',
        'cover'       => 'http://www.starsatnight.org/sites/sciencetheater/assets/File/200x300_blackholes.png',
        'creator_id'  => 2,
        'active'      => true,
        'type_id'     => 2,
      ...
      DB::table('shows')->insert([
        ...
        'duration'    => 45,
        'description' => 'Write a description here.',
        'cover'       => 'http://www.starsatnight.org/sites/sciencetheater/assets/File/200x300_daftpunk.png',
        'creator_id'  => 2,
        'active'      => true,
        'type_id'     => 2,
        'created_at'  => Date::now('America/Chicago')->toDateTimeString(),
