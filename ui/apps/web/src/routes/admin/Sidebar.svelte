...
<aside class="hidden h-screen w-64 lg:flex lg:flex-col lg:border-x">
	<div class="mb-2 flex h-16 items-center gap-3 border-b px-6">
		<svg
			viewBox="0 0 24 24"
	...
	<div class="flex grow flex-col justify-end gap-6 p-3">
		{#if account}
