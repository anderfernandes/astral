...
@section('title', "Astral - " . App\Setting::find(1)->organization . " - Receipt #$sale->id")

@section('content')

  <center>
    <img src="{{ (App\Setting::find(1)->logo == '/logo.png') ? substr(App\Setting::find(1)->logo, 1) : Storage::url(App\Setting::find(1)->logo) }}" style="width:35px; height:auto">
    <h3>Receipt</h3>
  </center>
