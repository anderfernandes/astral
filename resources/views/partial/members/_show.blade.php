<div class="ui container">
  ...
  <a href="{{ route('cashier.members.index') }}" class="ui basic black button">
    <i class="left chevron icon"></i> Back
  </a>
  <a href="{{ route('cashier.users.edit', $member->primary) }}" class="ui yellow button">
    <i class="edit icon"></i> Edit Member
  </a>
  <a href="{{ route('cashier.members.create') }}" class="ui secondary button">
    <i class="ui icons">
  ...
  <a href="{{ route('cashier.members.edit', $member) }}" class="ui yellow button">
  ...
  <div class="ui dropdown black button">
    ...
    <div class="menu">
      <a href="{{ route('cashier.members.receipt', $member) }}" target="_blank" class="item">
        <i class="file icon"></i>Receipt
      </a>
      <a href="{{ route('cashier.members.card', $member) }}" target="_blank" class="item">
        <i class="address card icon"></i> Card
      </a>
      <a href="{{ route('cashier.members.receipt', $member) }}?format=pdf" target="_blank" class="item">
    ...
    <table class="ui very basic unstackable table">
      ...
      <tbody>
        @foreach($member->secondaries as $secondary)
            <tr>
              <td>
                <a href="{{ route('cashier.users.show', $secondary) }}" class="ui small header">
                  <i class="address card icon"></i>
                  <div class="content">
                    {{ $secondary->fullname }}
                    <div class="sub header">
              ...
              <td>
                <div class="ui icon buttons">
                  <a href="{{ route('cashier.users.edit', $secondary) }}" class="ui yellow button">
                    <i class="edit icon"></i>
                  </a>
                  <a href="{{ route('cashier.members.card', $member) }}?index={{ $loop->index }}" target="_blank" class="ui black button">
                    <i class="address card icon"></i>
                  </a>
                </div>
              </td>
...
<div class="ui basic modal" id="secondary">
  ...
  {!! Form::model($member, ['route' => ['cashier.members.addSecondary', $member], 'class' => 'ui form', 'method' => 'PUT']) !!}
  <div class="content">
