    ...
    <div class="ui four doubling cards">
      ...
      <div class="card">
        <div class="content">
          ...
          <div class="description">This reports shows revenue and attendance on an event type during a given date/time range.</div><br />
          <div class="ui form">
            <div class="field">
              <label for="closeout_user">Select the event type:</label>
              {!! Form::select('closeout_user', $event_types, null, ['class' => 'ui fluid selection search scrolling dropdown', 'id' => 'closeout-user']) !!}
            </div>
            <div class="field">
              <label for="closeout_start">Select date and time range:</label>
                <div class="ui left icon input">
        ...
        <div id="closeout-submit" class="ui bottom attached black button">Get Event Type Attendance Report <i class="right chevron icon"></i></div>
      </div>
      ...
      <div class="card">
        <div class="content">
          ...
          <div class="ui form">
            <div class="field">
              ...
              {!! Form::select('closeout_user', $ticket_types, null, ['class' => 'ui fluid selection search scrolling dropdown', 'id' => 'closeout-user']) !!}
            </div>
            <div class="field">
              <label for="closeout_start">Select the payment range:</label>
                <div class="ui left icon input">
        ...
        <div id="closeout-submit" class="ui bottom attached black button">Get Ticket Type Attendance Report <i class="right chevron icon"></i></div>
      </div>
    </div>
  </div>
