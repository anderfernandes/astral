...
<style>
  .blue.card {
    ...
    url('{{ \App\Setting::find(1)->cover == ' /cover.jpg' ? \App\Setting::find(1)->cover : Storage::url(\App\Setting::find(1)->cover) }}') !important;
    background-size: cover !important;

    width: {
        {
        App\Setting: :find(1)->membership_card_width
      }
    }
    ...
    height: {
        {
        App\Setting: :find(1)->membership_card_height
      }
    }
...
<div class="ui blue card" style="margin:0 0 0 0">
  <div class="content">
    ...
    @if (App\Setting::find(1)->astc)
    <div class="right floated meta">
      <img src="/ASTC_LOGO_HL_SQ.png" style="height: 20px">
    </div>
    @endif
  </div>
