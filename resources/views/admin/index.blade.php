...
function getSalesTotals($day)
{
  ...
  foreach ($dailySales as $dailySale) {
    $dailyTotal += $dailySale->total;
  }
  return number_format($dailyTotal, 2);
}
    ...
    <div class="four wide computer eight wide mobile column">
      <div class="ui inverted raised center aligned segment">
        ...
        <div class="ui inverted large centered statistic">
          ...
          <div class="value">
            {{ getSalesTotals(Date::now('America/Chicago')) }}
          </div>
        ...
        <div class="ui two column grid">
          <div class="column">
            <div class="ui mini inverted statistic">
              <div class="value">$
                {{ getSalesTotals(Date::yesterday('America/Chicago')) }}
              </div>
              <div class="label">Yesterday</div>
            </div>
          </div>
          <div class="column">
            <div class="ui mini inverted statistic">
              <div class="value">$
                {{ getSalesTotals(Date::now('America/Chicago')->startOfWeek()) }}
              </div>
              <div class="label">This Week</div>
            </div>
          </div>
