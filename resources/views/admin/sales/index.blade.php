...
@section('content')
  ...
  <div class="ui container">
    ...
    <div class="seven fields">
      ...
      <div class="field">
        <div class="ui fluid selection search dropdown" id="sale-customer">
      ...
      <div class="field">
        <div class="ui fluid selection search dropdown" id="sale-organization">
      ...
      <div class="field">
        <div class="ui fluid selection dropdown" id="sale-status">
      ...
      <div class="field">
        <div class="ui fluid selection search dropdown" id="payment-user">
      ...
      <div class="field">
        {!! Form::button('<i class="search icon"></i> Search', ['type' => 'submit', 'class' => 'ui fluid secondary button']) !!}
      </div>
    </div>
    {!! Form::close() !!}
